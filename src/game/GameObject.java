...
/**
 * GameObjects are the objects on the InteractableWorld screen. Every GameObject has
 * a velocity, acceleration, position, direction, and dimensions. GameObjects can
 * detect if they are overlapping another GameObject and must implement methods for
 * collisions with every type of Unit.
 * @author blancont
 *
 */
